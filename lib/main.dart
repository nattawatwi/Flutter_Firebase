...
import 'package:flutter_lab_firebase/screen/edit_item_screen.dart';
import 'package:flutter_lab_firebase/screen/new_item_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Firebase LAB'),
    );
  }
}
